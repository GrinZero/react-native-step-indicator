...
const StepIndicator = forwardRef<StepIndicatorRef, StepIndicatorProps>(
  (
    {
      currentPosition = 0,
      stepCount = 5,
    ...
    const [customStyles, setCustomStyles] =
      useState<DefaultStepIndicatorStyles>({
        ...defaultStyles,
    ...
    useEffect(effectCustomStyles, [customStylesFromProps]);
